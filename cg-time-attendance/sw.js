// CG Time Attendance — minimal app-shell service worker.
// Only caches this app's own files (so it opens instantly and is
// installable). Never touches Microsoft Graph, sign-in, geolocation, or
// the MSAL CDN script — those always go straight to the network.
...
const CACHE_NAME = "cg-time-attendance-shell-v2";
const SHELL_FILES = [
  "./",
  "./index.html",
  "./manifest.json",
